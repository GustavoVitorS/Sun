...
function init() {
  ...
  radialGrad.addColorStop(1, 'rgba(223, 245, 39, 0.8)');
...
function render() {
  ...
  for (var p = 0; p < particles.length; p++) {
    ...
    bbCtx.fillStyle = "rgb(255, 165, 0)" + alpha + ")";
    bbCtx.fillRect(particle.x, particle.y, scl * 4, scl * 4);
